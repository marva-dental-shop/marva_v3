...
const cards = [
  ...
  {
    title: "Stories",
    desc: "Headerdagi stories videolarini qo'shish, yoqish va o'chirish",
    href: "/admin/stories",
    icon: Clapperboard,
  },
  {
    title: "ReelUp",
    desc: "Product bilan bog'langan ReelUp videolarini boshqarish",
    href: "/admin/reels",
    icon: Megaphone,
  },
  {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Mahsulotlar, stories, ReelUp, bannerlar, buyurtmalar va mijozlar bazasi
          </div>
        </div>
